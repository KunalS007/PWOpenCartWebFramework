...
- Name: searchpage.spec.ts >> Verify user is able to land on Product page macbook and MacBook Pro
- Location: tests/searchpage.spec.ts:25:1
...
Call log:
  - waiting for getByRole('link', { name: 'MacBook Pro', exact: true }).first()
    ...
    - generic [ref=e30]:
      ...
      - generic [ref=e36]:
        ...
        - button "" [active] [ref=e39] [cursor=pointer]:
          - generic [ref=e40]: 
      - generic [ref=e42]:
        - button " 540 item(s) - $1,071,612.00" [ref=e43] [cursor=pointer]:
          - generic [ref=e44]: 
          - text: 540 item(s) - $1,071,612.00
        - text:       
  - navigation [ref=e46]:
    - generic: 
    - list [ref=e48]:
...
```ts
  ...
  3  | 
  4  | export class SearchResultPage extends BasePage
  5  | {
  6  |     private readonly searchResult: Locator;
  7  | 
  8  |     constructor(page: Page)
  9  |     {
  10 |         super(page);
  11 |         this.searchResult = page.locator('div.product-layout');
  12 |     }
  13 | 
  14 |     async getSearchResultCount(): Promise<number>
  15 |     {
  16 |         return await this.searchResult.count();
  17 |     }
  18 | 
  19 |     async selectProduct(productName: string): Promise<void>
  20 |     {
> 21 |          await this.page.getByRole('link', { name: productName, exact: true }).first().click();
     |                                                                                        ^ Error: locator.click: Test timeout of 30000ms exceeded.
  22 |     }
  23 | }
```